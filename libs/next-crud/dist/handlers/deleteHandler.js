...
function deleteHandler({ adapter, response, resourceId, resourceName, query, request, middlewares, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const resource = yield adapter.getOne(resourceName, resourceId, query);
        if (resource) {
            const deletedResource = yield adapter.delete(resourceName, resourceId, query);
