...
function getJSONSchemaType(field) {
  ...
  return isRequired || isList ? scalarFieldType : isFieldUnion ? Array.from(new Set([...scalarFieldType, 'null'])) : [scalarFieldType, 'null'];
}
...
function getJSONSchemaForPropertyReference(field, {
  schemaId
}) {
