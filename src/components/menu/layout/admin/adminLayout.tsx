...
const navigation = [
  { name: 'Accueil', href: '#' },
  { name: 'Contenu', href: '#' },
  { name: 'Statistique', href: '#' },
  { name: 'Message', href: '#' },
]
const breadcrumbs = [
  { name: 'Contenu', href: '#', current: false },
            ...
            <div className="max-w-5xl mx-auto px-2 sm:px-4 lg:px-8">
              <div className="flex justify-between h-16">
                  ...
                  <div className="hidden lg:ml-8 lg:flex lg:space-x-4">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="rounded-md py-2 px-3 text-sm font-medium text-white hover:bg-indigo-400"
                      >
                        {item.name}
                      </a>
                    ))}
                  ...
                  <div className="max-w-lg w-full lg:max-w-xs">
                    ...
                    <div className="relative text-white focus-within:text-gray-400">
                      ...
                      <input
                        id="search"
                        name="search"
                        className="block w-full bg-indigo-400 border-transparent py-2 pl-10 pr-3 text-base leading-5 placeholder-white focus:outline-none focus:bg-white focus:ring-0 focus:border-white focus:text-gray-900 focus:placeholder-gray-400 sm:text-sm rounded-md"
                ...
                <div className="flex items-center lg:hidden">
                  {/* Mobile menu button */}
                  <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-indigo-200 hover:text-white hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                ...
                <div className="hidden lg:ml-4 lg:flex lg:items-center">
                  <button
                    type="button"
                    className="flex-shrink-0 bg-indigo-500 p-1 text-indigo-200 rounded-full hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-500 focus:ring-white"
                  >
                  ...
                  <Menu as="div" className="ml-4 relative flex-shrink-0">
                    <div>
                      <Menu.Button className="bg-indigo-500 rounded-full flex text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-500 focus:ring-white">
            ...
            <Disclosure.Panel className="lg:hidden">
              ...
              <div className="pt-4 pb-3 border-t border-indigo-500">
                <div className="flex items-center px-4">
                  ...
                  <button
                    type="button"
                    className="ml-auto flex-shrink-0 bg-indigo-500 rounded-full p-1 text-indigo-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-500 focus:ring-white"
                  >
